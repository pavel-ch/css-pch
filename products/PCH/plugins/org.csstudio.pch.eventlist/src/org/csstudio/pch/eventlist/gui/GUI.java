...
import org.csstudio.pch.eventlist.Activator;
import org.csstudio.pch.eventlist.Preferences;
import org.csstudio.pch.eventlist.PropertyColumnPreference;
...
public class GUI implements ModelListener, DisposeListener
{
    ...
    public GUI(IWorkbenchPartSite site, final Composite parent, final Model model)
    {
		...
		archiveRDBStore = new ScopedPreferenceStore(
    			InstanceScope.INSTANCE, org.csstudio.pch.eventlist.Activator.ID);
